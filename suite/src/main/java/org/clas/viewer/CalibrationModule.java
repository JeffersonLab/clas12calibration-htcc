...
public class CalibrationModule extends CalibrationEngine implements CalibrationConstantsListener {
    ...
    private DetectorShape2D                   selectedKey =new DetectorShape2D();
    ...
    public CalibrationModule(String ModuleName, String Constants,int Precision, ConstantsManager ccdb, Map<String,CalibrationConstants> gConstants) {
...
//        System.out.println(str_sector + " " + str_layer + " " + str_component);
        ...
        this.selectedKey.getDescriptor().setSectorLayerComponent(sector, layer, component);
 ...
 //               resetEventListener();
                ...
                processEvent(event);
                System.out.println("EVENT_SINGLE from CalibrationModule");
        }
    ...
    public DetectorShape2D getSelectedKey() {
        return selectedKey;
    }
